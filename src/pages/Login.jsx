      ...
      <div>
        <div className="login-page flex">
          ...
          <div className="login-container w-1/2 bg-primary h-screen ">
            <div
              className="login-elements h-screen flex flex-col justify-center items-center"
              style={{
                backgroundImage: `url(${FBNBg})`,
