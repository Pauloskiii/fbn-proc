  ...
  return (
    <div className="width-main flex justify-between mb-12">
      <div className="header-title">
        <h1 className="text-3xl font-semibold" style={{ color: "#5B5B5B" }}>
          {currentPage}
        </h1>
      </div>
      <div className="header-nav flex">
        ...
        <div
          className="header-user mr-4 border-rounded"
          style={{ backgroundColor: "#D9D9D9", padding: "8px 16px" }}
        >
