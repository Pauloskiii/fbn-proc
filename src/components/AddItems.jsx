...
import { FaPlusCircle, FaCheckCircle, FaTrashAlt } from "react-icons/fa";
        ...
        <form action="" onSubmit={submitForm}>
          <div className="form-group flex">
            <div className="form-item flex flex-col mr-4">
              ...
              {itemError && <span className="error mt-1">{itemError}</span>}
              {quantityError && (
                <span className="error mt-1">{quantityError}</span>
              )}
            </div>
            <div className="form-item flex flex-col mr-4">
              <label
          ...
          <div className="form-group">
            <SubmitButton btnText={"Send Request"} btnIcon={true} />
          </div>
        </form>
